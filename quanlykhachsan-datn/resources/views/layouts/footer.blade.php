    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 mb-4">
                ...
                <p class="small text-muted">Bãi biển Đất Dốc, Huyện Côn Đảo, Tỉnh Bà Rịa - Vũng Tàu, Việt Nam</p>
            </div>
            ...
            <div class="col-md-3">
                ...
                <p class="small text-muted mb-1">T: +84 28 3823 2229</p>
                <p class="small text-muted">E: reservations-condao@sixsenses.com</p>
            </div>

            <div class="col-md-3 text-md-end">
                <h6 class="footer-title fw-bold small mb-3 text-uppercase">Theo dõi</h6>
                <div class="d-flex justify-content-md-end gap-3 text-muted">
        ...
        <p class="text-center small text-muted">© 2026 Six Senses Hotels Resorts Spas. All rights reserved.</p>
    </div>
</footer>
