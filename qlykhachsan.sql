...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 20, 2026 lúc 09:27 PM
...
(20, '502', 'Standard', 750000.00, 2, 'Trống', 'Standard cao cấp với ban công / view nhìn phố, âm thanh cách âm tốt, có khu vực nhỏ tiếp khách / ghế thư giãn.', 'https://hocquanlynhahangkhachsan.wordpress.com/wp-content/uploads/2018/04/86481-nhieu-loai-phong-khach-nhau.jpg', '300 foot vuông / 28 mét vuông', 'Hướng vườn', 1, 'Wi-Fi tốc độ cao miễn phí\r\nTivi màn hình phẳng\r\nĐiều hòa nhiệt độ\r\nPhòng tắm vòi sen đứng\r\nMinibar cơ bản\r\nMáy sấy tóc', 'Tầm nhìn hướng vườn xanh mát\r\nGiường King hoặc 2 giường đơn\r\nKhông gian ấm cúng phù hợp cho cặp đôi\r\nBan công nhỏ riêng biệt\r\nKhông hút thuốc trong phòng');
...
--
ALTER TABLE `taikhoan`
  MODIFY `id_taikhoan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
